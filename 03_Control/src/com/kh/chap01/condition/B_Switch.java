...
//				break;
//	...
//	default : 실행할 코드 // if~ else문에서 else와 같은 역할
//						// 위의 값1,값2,값n... 앞으로 동등비교를할 대상과 하나도 일치하지 않다면, default내의 실행할코드가 실행된다.
	
//	}
//	switch문 자주사용되진 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과가 수행되어야 하는경우
//	ex) 키보드입력, 마우스입력등
...
//		잘못된 과일을 입력시 "저희가게에서 판매하는 과일이 아닙니다"
