...
//	
//	조건문
//	조건식을 통해 참이냐 거짓이냐를 판단을해서 그에 해당하는 코드를 실행
//	
//	조건식
//	반드시 결과는 true/false 여야함.
//	보통의 조건식에는 비교연산자, 논리연산자를 주로 사용함.
//	
//	조건문은 크게 if문(단독, if~else, is ~else if, 중복if) switch문으로 나뉨
...
//		}]
	...
	public void method4() {
//		사용자가 입력한 아니값을 가지고 어린이/청소년/성인 출력
...
//		String 참조자료형
		if(name == "동히") {
			System.out.println("동히님 반갑습니다.");
		}else {
			System.out.println("동히님이 아니신가보네요?");
		}
...
//		그럼 어떻게 하냐? 문자열.eqauls() 라는 방법으로 비교를 함.
		
		if(name.equals("동히")){ // 즉 반환값이 true or false로 리턴해줌.
			System.out.println("동히님 반갑습니다.");
		}else {
			System.out.println("동히님이 아니신가보네요?");
		}
