...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("시급 : 11,000원");
		
		System.out.println("근무시간 : 4시간");
		
		System.out.println("근무일 : 5일");
		...
		System.out.println("동히 : " + (11000 * 4 * 5) + "원 입니다.");
		...
		System.out.println("동히 : " + (pay * time * day) + "원 입니다.");
		System.out.println("홍길동 : " + (pay * (time + 10) * day) + "원 입니다.");
		System.out.println("고길동 : " + (pay * time * (day + 4)) + "원 입니다.");
		System.out.println("윰미 : " + (pay * (time + 10) * (day + 35)) + "원 입니다.");
		
//		변수를 사용하는 이유
//		1. 변수는 우선적으로 값에 의미를 부여할 목적으러 사용(가독성이 좋음)
//		2. 단 한번 값을 기록해두고 필요할떄마다 꺼내서 계속 사용할 목적으로 사용(재사용)
//		3. 유지보수를 보다 쉽게 할수 있다.
...
//			[표현법] 변수명 = 값(literal);
			...
			sNum = 2;
			iNum = 4;
			lNum = 8L; // long 자료형임을 알려주기위해 소문자나 대문자 L을 표기해줌(L더 권장)
...
//			각 변수에 담긴 값 출력
		...
		public void constantVariable() {
			...
			final int AGE = 20; // 상수 값은 final 사용 사용시 변수는 전부 대문자
