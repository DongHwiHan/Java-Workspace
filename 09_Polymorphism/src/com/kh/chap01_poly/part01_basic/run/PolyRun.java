...
//		객체 배열을 이용하기
		...
		arr2[0] = new Child2(6, 6, 6);
		arr2[1] = new Child2(0, 0, 0);

//		단, 다형성이 적용되면 부모타입 레퍼런스 변수로 모든 자식객체를 다받아줄수 있다.
		System.out.println("\n===== 다형성 접목한 객체배열 =====\n");
		Parent[] arr3 = new Parent[4];
		arr3[0] = new Child1(1, 2, 3);
		arr3[1] = new Child2(4, 5, 6);
		arr3[2] = new Child1(7, 8, 9);
		arr3[3] = new Child2(10, 11, 12);
