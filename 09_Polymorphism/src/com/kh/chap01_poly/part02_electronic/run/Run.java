...
import com.kh.chap01_poly.part02_electronic.moldel.vo.*;
...
////		생성과 동시에 이 클래스의 필드값(desk, tap, note)들이 메모리 영역에 null값으로 추가됨.
...
//		2. 다형성을 적용한 후
		...
		ec.insert(new Desktop("삼성", "데답", 999999, "Gegorce 1070"), 0);
