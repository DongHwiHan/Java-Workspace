...
//	7) 스트림을 통해 입력 및 출력
//	8) 통신종료
//	- inputStream, OutputStram, Socket을 전부 닫아줘야함(close())

	public void serverStart() {
//		0) 포트번호 지정
//		- 0~1023 시스템 포트번호
//		- 1024~65535 까지의 포트번호를 사용하는것을 추천
		int port = 30027;
		int clientCnt = 0;
...
//				4) 클라이언트의 정보를 저장.
				...
				System.out.println(++clientCnt + "클라이언트 연결 됨...");
...
//				클라이언트로 부터 전달된 값을 한줄단위로 읽어들이기위한 입력용 스트림
