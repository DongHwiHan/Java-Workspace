...
//	1) 기본 사용법
public enum Day1 {
	MONDAY, TUESDAY, WENDSEDAY, THURSDAY, FRIDAY, SATURSDAY, SUNDAY
}
...
//	1) 각 요소마다 우측에 매칭시킬값을 추가함.
	MONDAY("MOM"), TUESDAY("TUE"), WENDSEDAY("WEN"), THURSDAY("THU"), FRIDAY("FRI"), SATURSDAY("SAT"), SUNDAY("SUN");
...
//	매핑 시킬값이 여러개인경우
	enum Day3 {
		...
		MONDAY("MON", 1), TUESDAY("TUE", 2), WENDSEDAY("WEN", 3), THURSDAY("THU", 4), FRIDAY("FRI", 5),
		SATURSDAY("SAT", 6), SUNDAY("SUN", 7);
...
//			함수추가 2단계) 추상메서드를 상수필드에서 오버라이딩
			...
			public void printDay() {
				System.out.println("월요일이무니다.");
			};
		},
		TUESDAY("TUE", 2) {
			@Override
			public void printDay() {
				System.out.println("화요일이무니다.");
			};
		},
		WENDSEDAY("WEN", 3) {
			@Override
			public void printDay() {
				System.out.println("수요일이무니다.");
			};
		},
		THURSDAY("THU", 4) {
			@Override
			public void printDay() {
				System.out.println("목요일이무니다.");
			};
		},
		FRIDAY("FRI", 5) {
			@Override
			public void printDay() {
				System.out.println("금요일이무니다.");
			};
		},
		SATURSDAY("SAT", 6) {
			@Override
			public void printDay() {
				System.out.println("토요일이무니다.");
			};
		},
		SUNDAY("SUN", 7) {
			@Override
			public void printDay() {
				System.out.println("일요일이무니다.");
			};
