...
//		왜? 필드명과 매개변수명이 동일한경우{} 영역 내에서는 해당 영억에서 만들어진 변수가 좀 더 우선순위가 높기때문.
...
//	get+필드명(카멀케이스적용)
	public String getName() {// void : 반환하는 값이 없을경우 작성
		return name; // return 반환값; -> 반환값을 나를 호출한 메서드의 위치레 전달하겠다.
	}
